---
website: "Site Institucional do Município de Vila Flor"          # Entre as aspas escreve o nome do website
date: "31/12/1999"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.cm-vilaflor.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.cm-vilaflor.pt/declaracao-de-acessibilidade-e-usabilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Município de Vila Flor"         # Entre as aspas escrever o nome do owner do website
